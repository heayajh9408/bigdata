library(ggplot2)
library(dplyr)
# 연습문제 1. datasets::cars데이터 셋을 이용하여 속도에 대한 제동거리의 산점도와 적합도(신뢰구간 그래프)를 나타내시오(단, 속도가 5부터 20까지 제동거리 0부터 100까지만 그래프에 나타냄).
?cars
...
ggsave('0215.시각화연습문제그래프들/ex01.png')
...
ggsave('0215.시각화연습문제그래프들/ex02.png')
...
ggsave('0215.시각화연습문제그래프들/ex03.png')
...
ggsave('0215.시각화연습문제그래프들/ex04.png')
...
ggsave('0215.시각화연습문제그래프들/ex05.png')
...
ggsave('0215.시각화연습문제그래프들/ex06.png')
...
ggsave('0215.시각화연습문제그래프들/ex07.png')
...
ggsave('0215.시각화연습문제그래프들/ex08.png')
...
ggsave('0215.시각화연습문제그래프들/ex09.png')
...
ggsave('0215.시각화연습문제그래프들/ex10.png')
