...
public class LibMain {
	public static void main(String[] args) {
		Book[] books = { new Book("890ㄱ-100", "java", "아무개"), new Book("890ㄱ-101", "hadoop", "저무개"),
				new Book("890ㄱ-102", "oracle", "이무개"), new Book("890ㄱ-103", "python", "김무개"),
				new Book("892ㄱ-100", "spark", "신무개") };
