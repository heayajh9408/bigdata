...
public class Ex03_arrayListvsLinkedList {
	public static void main(String[] args) {
		...
		System.out.println("arrayList 끝인덱스로 추가 시간 :" + addSeqTime(array));
		System.out.println("linkedList 끝인덱스로 추가 시간 :" + addSeqTime(linked));
	...
	private static long addRandTime(List<String> list) {
		long start = System.currentTimeMillis(); // for문 수행 전시간
